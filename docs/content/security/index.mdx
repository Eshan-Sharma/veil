...
Full audit reports are published under [Audit Reports](/security/audits) and numbered in the order they were performed:

1. [Internal Deep Review](/security/audits/01-internal-deep-review) — 2026-04-27, on-chain math, oracle, frontend, API
2. [Adversarial Audit](/security/audits/02-adversarial-audit) — 2026-04-28, attacker-first review of every instruction
3. [Frontend Security](/security/audits/03-frontend-security) — 2026-04-28, `veil-landing` API and auth surface
4. [Red-Team Report](/security/audits/04-red-team-report) — 2026-04-28, hostile end-to-end review
